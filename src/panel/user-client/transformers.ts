import {Allocation} from './server/getServer'
import {FileObject} from './server/files/loadDirectory'
import {FractalResponseData, PaginationDataSet, ServerBackup, ServerEggVariable} from './server/types'
